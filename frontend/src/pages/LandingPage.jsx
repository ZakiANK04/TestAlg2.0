...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            ...
            <motion.nav
                className="bg-white/95 shadow-md sticky top-0 z-50 border-b border-emerald-100/50"
                        ...
                        >
                            ...
                            >
                                ...
                                <motion.button
                                    ...
                                    className="px-8 sm:px-10 py-4 sm:py-5 bg-white/10 border-2 border-white/30 text-white rounded-xl font-bold text-lg sm:text-xl hover:bg-white/20 transition-all relative overflow-hidden group"
                                    whileHover={{ 
                                        scale: 1.05,
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        {features.map((feature, index) => (
                            <motion.div
                                ...
                                className="group relative bg-white/80 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all border border-slate-200/50 hover:border-emerald-300 overflow-hidden"
                                style={{ transformStyle: 'preserve-3d' }}
                            >
